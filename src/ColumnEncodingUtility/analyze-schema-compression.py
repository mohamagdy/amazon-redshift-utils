...
def usage(with_message):
    ...
    print('           --copy-to-s3            - Unloads the table to be compressed to S3 and copy to compressed table')
    print('           --s3-full-path          - Set S3 full path to copy table to')
    print('           --aws-access-key-id     - Set AWS Access Key ID')
    print('           --aws-secret-access-key - Set AWS Secret Access Key')
    print(
